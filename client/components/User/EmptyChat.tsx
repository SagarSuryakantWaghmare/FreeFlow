...
const EmptyChat: React.FC = () => {
  return (<div className="flex flex-1 h-full min-h-0 m-0 p-0 items-center justify-center flex-col text-center overflow-y-auto bg-gray-50 dark:bg-zinc-950">
    ...
    {/* <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6 mt-2 sm:mt-4 max-w-3xl px-2">
      <div className="flex flex-col items-center p-3 sm:p-4 rounded-lg bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800">
        <Shield className="h-6 w-6 sm:h-8 sm:w-8 text-purple-500 dark:text-purple-500 mb-1 sm:mb-2" />
      ...
      <div className="flex flex-col items-center p-3 sm:p-4 rounded-lg bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800">
        <Lock className="h-6 w-6 sm:h-8 sm:w-8 text-purple-500 dark:text-purple-500 mb-1 sm:mb-2" />
      ...
      <div className="flex flex-col items-center p-3 sm:p-4 rounded-lg bg-card border border-border">
        <Users className="h-6 w-6 sm:h-8 sm:w-8 text-purple-500 dark:text-purple-500 mb-1 sm:mb-2" />
